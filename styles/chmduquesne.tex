...
\setupcolor[hex]
\definecolor[titlegrey][h=cc0000]
\definecolor[sectioncolor][h=330000]
...
\definefontfamily [mainface] [ss] [TeX Gyre Adventor]
...
\setuplayout    [width=middle, height=middle,
                 ...
                 topspace=25mm, bottomspace=20mm,
...
\setupblackrules[width=31mm, color=rulecolor, height= 3pt]
...
\definedescription
  ...
  [headstyle=bold, style=normal,
   location=hanging, width=28mm, distance=8mm, margin=0cm]
